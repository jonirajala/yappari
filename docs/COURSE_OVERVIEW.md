# Mojibun - Course Overview

High-level roadmap and design decisions. For detailed exercise-by-exercise breakdown, see `COURSE.md` (auto-generated from code via `npm run course-doc`).

## Phases

The course follows a research-backed progression for beginner Japanese:

| Phase | Units | Focus |
|-------|-------|-------|
| 1: Survival basics | 1-6 | Greetings, self-intro, demonstratives, objects, possession, location |
| 2: People & places | 7-10 | Family, numbers, time, places, first verbs |
| 3: Daily life | 11-14 | Polite verbs, food/drink, actions, adjectives, routines |
| 4: Getting around | 15-18 | Transport, directions, shopping, weather |
| 5: Expanding communication | 19-24 | Hobbies, health, colors, counters, plans, experiences |

## Unit Roadmap

| Unit | Title | Status | Lessons | Main content |
|------|-------|--------|---------|--------------|
| 1 | Hello! | Done | 5 | こんにちは, おはようございます, こんばんは, さようなら |
| 2 | Please & Thank You | Done | 5 | ありがとうございます, すみません, はい, いいえ, おねがいします |
| 3 | I Am... | Done | 7 | わたし, は/です, か, じゃないです, self-introduction |
| — | ⭐ Milestone 1: Survival Checkpoint | Done | 1 | Cross-unit review of Units 1-3 (70% to pass) |
| 4 | What Is This? | Done | 5 | これ/それ/あれ, なん, ほん, ペン, かばん, でんわ |
...
| 18 | Weather & Seasons | Future | — | Hot, cold, weather, seasons |
| 19 | Hobbies & Interests | Future | — | Movies, music, sports, activities |
| 20 | Body & Health | Future | — | Body parts, health, feeling well/unwell |
| 21 | Colors & Appearance | Future | — | Colors, appearance, descriptive contrast |
| 22 | Counters & Quantities | Future | — | ～つ, ～人, ～本, ～枚 |
| 23 | Invitations & Plans | Future | — | Invitations, suggestions, simple plans |
| 24 | Experiences & Preferences | Future | — | Likes, wants, experience, comparisons |

## Grammar Stages

Grammar is introduced in stages that align with the unit roadmap.

### Stage A: Units 1-6 (implemented)

Core noun-based beginner Japanese. No verbs yet.
...
Connect ideas for practical public-life communication.

**Planned:** と, や, から, けど/けれども, ので

### Stage E: Units 19-22

Requesting, allowing, prohibiting.

**Planned:** て-form, てください, てもいい, てはいけない

### Stage F: Units 23-24+

Richer conversation and fluency.

**Planned:** ている, たい, ほしい, ましょう/ましょうか, ませんか, たことがある, comparisons (より, ほうが, いちばん)

## Milestone Reviews

Milestones sit between units on the journey map. They test all previous knowledge and require 70% to pass (vs 50% for regular lessons). They gate the next unit.

| | Unit Quiz | Milestone Review |
|---|---|---|
| **Scope** | Mostly that unit + some review | All previous units equally |
| **Length** | 12-15 exercises | 15-22 exercises |
| **Teaching** | May have vocab_intro | Pure testing, zero teaching |
| **Exercise mix** | ~50/50 recognition/production | ~60% production, ~40% recognition |
| **Pass threshold** | 50% | 70% |
| **Visual** | Regular lesson node | Gold trophy node between units |
| **Gating** | Unlocks next lesson | Unlocks next unit |
...
- Units 1-2 stay extremely gentle — no grammar, pure vocabulary
